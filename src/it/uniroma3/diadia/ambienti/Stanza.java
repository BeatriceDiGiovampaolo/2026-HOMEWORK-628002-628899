...
public class Stanza {
    ...
    public boolean addAttrezzo(Attrezzo attrezzo) {
        if (this.getNumeroAttrezzi() < NUMERO_MASSIMO_ATTREZZI) {
        	this.attrezzi[getNumeroAttrezzi()] = attrezzo;
	...
	*/
	...
	public boolean removeAttrezzo(Attrezzo attrezzo) {
			...
			for(int i=0; i<getNumeroAttrezzi() && !trovato; i++) {
				if(attrezzi[i].getNome().equals(attrezzo.getNome())){
					attrezzi[i]=attrezzi[getNumeroAttrezzi()-1]; 
					attrezzi[getNumeroAttrezzi()-1]=null; 
					setNumeroAttrezzi(getNumeroAttrezzi() - 1); 
					trovato = true; 
				}
			}
			return trovato;
